    ...
    <footer class=" justify-content-between py-3 my-4 border-top">
        <div class="row">
          ...
          <div class="col">
              ...
              <p class="text-decoration: none"><a href="{{url('login')}}">Entre</a> ou <a href="{{url('register')}}">Cadastre-se</a></p>
          ...
          <div class="col">
          <p><a href="{{url('sobre')}}">Sobre nós </a></p>
            <p> <a href="{{url('contato')}}">Trabalhe Conosco</a> </p>
