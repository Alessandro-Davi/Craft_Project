...
@section('content')
    ...
    <div class="container">
        <div class="card-group row row-cols-4">
            <div class="card border border-dark">
                <a href="{{ url('listar_publi/1') }}"><img src="{{ url('./img/Artes.jpg') }}" class="card-img-top"
                        alt="..."></a>
            ...
            <div class="card border border-dark">
                <a href="{{ url('listar_publi/2') }}"><img src="{{ url('./img/Mecanica.jpg') }}" href="#"
            ...
            <div class="card border border-dark">
                <a href="{{ url('listar_publi/3') }}"><img src="{{ url('./img/Decoração.jpg') }}" href="#"
                        class="card-img-top" alt="..."></a>
                <div class="card-body text-center">
            ...
            <div class="card border border-dark">
                <a href="{{ url('listar_publi/4') }}"><img src="{{ url('./img/Eletrônica.jpg') }}" href="#"
                        class="card-img-top" alt="..."></a>
                <div class="card-body text-center">
    ...
    <div class="container">
        ...
        <div class="card-group row row-cols-4">
            <div class="card border border-dark">
                <a href="{{ url('listar_publi/5') }}"><img src="{{ url('./img/Costura.jpg') }}" href="#"
                        class="card-img-top" alt="..."></a>
                <div class="card-body text-center">
            ...
            <div class="card border border-dark">
                <a href="{{ url('listar_publi/6') }}"><img src="{{ url('./img/Presentes.jpg') }}" href="#"
                        class="card-img-top" alt="..."></a>
                <div class="card-body text-center">
            ...
            <div class="card border border-dark">
                <a href="{{ url('listar_publi/7') }}"><img src="{{ url('./img/quadro.png') }}" href="#"
                        class="card-img-top" alt="..."></a>
                <div class="card-body text-center">
            ...
            <div class="card border border-dark">
                <a href="{{ url('listar_publi/8') }}"><img src="{{ url('./img/bijuteria.jpeg') }}" href="#"
                        class="card-img-top" alt="..."></a>
                <div class="card-body text-center">
